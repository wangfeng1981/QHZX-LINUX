...
string programid = "fy4olrm15monitorfordb" ;
...
string make_fy4m15_insertsql( string filepath , string thumbfile , 
    string tablename ,//modify 2017-10-11
     string productid //modify 2017-10-11
     )
{
        string filename = wft_base_name(filepath) ;
        string dtstr = wft_get_datetimestr_from_fy4filename(filename) ;
...
int main(int argc ,char** argv)
{
        ...
        std::cout<<"version 0.2a . by wangfengdev@163.com 2017-10-11. "<<std::endl ;
        if( argc == 1 )
        {
        ...
        //modi 2017-10-11 string programid = "fy4 xxx m15monitorfordb" ;
        ...
        //new 2017-10-11.
        string tableName =wft_getValueFromExtraParamsFile(
                        startupfile , 
                        "#tablename" , 
                        true 
                        ) ;
        string productId =wft_getValueFromExtraParamsFile(
                        startupfile , 
                        "#productid" , 
                        true 
                        ) ;
                        ...
                        if( wft_test_file_exists(thumbfilepath) )
                        {
                                ...
                                {  
                                        string insertSql = make_fy4m15_insertsql(filepath,
                                                thumbfilepath , tableName , productId );
