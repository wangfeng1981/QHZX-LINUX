...
reset
set terminal png noenhanced size 1200,1050 font '/root/ncc-fy4-project/extras/libsans-reg.ttf'
set output '{{{OUTFILE}}}'
set encoding utf8
set multiplot
#title lables ########## font
set label 1 "{{{TITLE1}}}" at screen 0.5, screen 0.96 font '/root/ncc-fy4-project/extras/libsans-reg.ttf,16' center 
set label 2 "{{{TITLE2}}}"  at screen 0.5, screen 0.93 font '/root/ncc-fy4-project/extras/libsans-reg.ttf,16' center
#plot1
...
####################################
splot '/root/ncc-fy4-project/extras/land_0125half.llv.txt' u 1:2:(0.5):3  with pm3d ,  '{{{INFILE}}}' using 1:2:(0.5):( ($3<260)*260 + ($3>=260)*$3 ) with pm3d , '/root/ncc-fy4-project/extras/world_110m.txt' u 1:2:(0.501) with lines lt 1 lc 'grey' , '/root/ncc-fy4-project/extras/china.dat' u 1:2:(0.501) with lines lt 1 lc '#ccbbdd'  
