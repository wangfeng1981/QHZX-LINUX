...
#title lables
set label 1 "{{{PNAME}}}" at screen 0.5,0.96 center font '/QHZX_DATA/extras/libsans-reg.ttf,16' 
set label 2 "{{{YMD01}}}" at screen 0.5,0.93 center font '/QHZX_DATA/extras/libsans-reg.ttf,16' 
set label 3 "Produced:{{{PTIME}}}" at screen 0.5,0.91 center font '/QHZX_DATA/extras/libsans-reg.ttf,10' 
