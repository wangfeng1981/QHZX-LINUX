...
set output "sample-olrwind-params.txt.png"
set encoding utf8
set multiplot
#title lables
set label 1 "FY4A OLR (W/m^2) 4Km With NCEP Wind 850hPa" at screen 0.02, screen 0.96 font '/QHZX_DATA/extras/libsans-reg.ttf,12' left  
set label 2 "Date from 2017-12-01 to 2017-12-02; Geo:[100,120,10,-10]." at screen 0.02, screen 0.93 font '/QHZX_DATA/extras/libsans-reg.ttf,12' left
set label 3 "Produced:2017-12-08 22:41:45; CFC:2."  at screen 0.02, screen 0.90 font '/QHZX_DATA/extras/libsans-reg.ttf,12' left
...
plot   "sample-olrwind-params.txt.png.tmp" using 1:2:3 with image \
