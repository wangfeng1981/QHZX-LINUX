...
set label 1 "FY3B NDVI {{{TITLE}}} 1Km Monthly " at screen 0.5, screen 0.1 font '/root/ncc-fy4-project/extras/libsans-reg.ttf,32' center 

set label 2 "Produced:{{{PTIME}}}" at screen 0.02, screen 0.02 font '/root/ncc-fy4-project/extras/libsans-reg.ttf,12' left  
