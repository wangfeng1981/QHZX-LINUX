...
reset
#heatmap
set terminal png noenhanced size 4000,2780 font "/QHZX_DATA/extras/libsans-reg.ttf,16"
set output '{{{OUTFILE}}}'
set encoding utf8
set multiplot
...
set label 1 "MOD13Q1 NDVI {{{TITLE}}} 250m 16-Days " at screen 0.5, screen 0.1 font '/QHZX_DATA/extras/libsans-reg.ttf,32' center 
