// fy4combine.cpp : ¶¨Òå¿ØÖÆÌ¨Ó¦ÓÃ³ÌÐòµÄÈë¿Úµã¡£
//fy4Ò£¸Ð²úÆ·×Ô¶¯ºÏ³É
...
void getFilesUnderDir(string dir, vector<string>& filesVector)
{
	...
	wft_linux_get_dir_files(dir , filesVector ) ;//linux
}
...
int main(int argc , char** argv )
{
	...
	cout << "Version 0.1.4a for linux . 2017-10-20 . modified for linux." << endl;
	cout << "Version 0.1.5a and for linux. 2017-10-23 . add 30min , 1hour period combination type. startup add hour minu location param. add log." << endl;
	cout << "Version 0.1.6a and for linux. 2017-10-24 . close log."<<endl ;

	if (argc == 1)
	{//2017-10-23 改到了这里; 2017-10-24继续。
						...
						{//如果时间范围包含了当前时间。
							...
							else
							{
								...
								if (retcode != 0) {
									...
									{
										cout<<"max error. out."<<endl ;//linux 2017-10-24
