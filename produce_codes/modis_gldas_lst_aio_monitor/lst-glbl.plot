...
reset
set terminal png noenhanced size 1600,900 font "/QHZX_DATA/extras/libsans-reg.ttf"
set output "{{{OUTFILE}}}"
set multiplot
set encoding utf8
set pm3d map
...
unset key 
set grid
set colorbox vertical user origin 0.91 , 0.1 size 0.03,0.7
set xrange[-180:180]
set x2range[-180:180]
set yrange[-90:90]
set cbrange[256:320]
...
set label 1 "{{{PNAME}}}" at screen 0.05,0.93 left  font "/QHZX_DATA/extras/libsans-reg.ttf,24" 
set label 2 "{{{YMD}}}" at screen 0.05,0.89 left font "/QHZX_DATA/extras/libsans-reg.ttf,24" 
