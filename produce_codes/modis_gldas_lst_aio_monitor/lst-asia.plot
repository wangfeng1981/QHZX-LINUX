#20E-160E 0-70N
reset
set terminal png noenhanced size 1200,600 font '/QHZX_DATA/extras/libsans-reg.ttf,13'
set output "{{{OUTFILE}}}"
set multiplot
set encoding utf8
set pm3d map
...
set label 1 "{{{PNAME}}}" at screen 0.05,0.93 left  font "/QHZX_DATA/extras/libsans-reg.ttf,18" 
set label 2 "{{{YMD}}}" at screen 0.05,0.89 left font "/QHZX_DATA/extras/libsans-reg.ttf,18" 
