...
####################################
splot '/QHZX_DATA/extras/land_0125half.llv.txt' using 1:2:(1):3 with pm3d , "{{{INFILE}}}" using 1:2:(1):( ($3<50)*50 + ($3>=50)*$3 ) with pm3d, r*cos(v)*cos(u),r*cos(v)*sin(u),r*sin(v) with lines lt 0 lc 'grey' ,'/QHZX_DATA/extras/world_110m.txt' u 1:2:(1.01) with lines lt 1 lc 'grey' , '/QHZX_DATA/extras/china.dat' u 1:2:(1.01) with lines lt 1 lc '#ccbbdd'  



#title lables font should change.
set label 1 "FY4A AGRI OLR {{{DATE}}} {{{TTYPE}}} 4Km" at screen 0.5,0.95 center font '/QHZX_DATA/extras/libsans-reg.ttf,16' 
