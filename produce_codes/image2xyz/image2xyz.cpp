// image2xyz.cpp : ¶¨Òå¿ØÖÆÌ¨Ó¦ÓÃ³ÌÐòµÄÈë¿Úµã¡£
//Ê¹ÓÃgdal»ùÓÚÍ¼ÏñµÄgeotransÊä³öx y zµÄÎÄ±¾ÎÄ¼þ¡£ 2017-11-7
...
{
	cout << "A program to use image's geotrans to output x,y,z ascii file. wangfeng1@piesat.cn." << endl;
	cout << "Version 0.1a .2017-11-7." << endl;
	cout << "Version 0.2a .region output.2017-11-7." << endl;
	cout << "Version 0.3a .output record info and yspace bug fixed. 2017-11-26." << endl;//2017-11-26

	if (argc == 1)
	{
		cout << "sample call:" << endl;

		cout << " image2xyz -in some.tif -out output.txt -valid0 -2 -valid1 10 [-scale 1] [-offset 0] [-xspace 1] [-yspace 1] [-nan NaN] [-x0 0 -x1 1 -y0 0 -y1 1]" << endl;
	...
	for (int iy = 0; iy < rasterYSize; ++iy)
	{
		...
		inds->GetRasterBand(1)->RasterIO(GF_Read, 0, iy, rasterXSize, 1,
